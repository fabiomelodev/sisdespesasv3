...
class RecurringTransactionResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'RecurringTransaction';

    protected static ?string $label = 'Transação Recorrente';

    protected static ?string $pluralLabel = 'Transações Recorrentes';
